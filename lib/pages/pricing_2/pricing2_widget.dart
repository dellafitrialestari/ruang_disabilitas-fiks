...
class Pricing2Widget extends StatefulWidget {
  const Pricing2Widget({Key? key}) : super(key: key);
                                        ...
                                        Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: SvgPicture.asset(
                                              'assets/images/reguler_hijau.svg',
                                        ...
                                        Padding(
                                          ...
                                          child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: SvgPicture.asset(
                                              'assets/images/silver_hijau.svg',
                                              width: MediaQuery.sizeOf(context)
                                                      .width *
                                                  0.2,
                                              height: MediaQuery.sizeOf(context)
                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                await launchURL(
                                    'https://dinsospmd.babelprov.go.id/content/kegiatan-day-care-kesehatan-mental-bagi-penyandang-disabilitas-mental');
                              },
                              child: Container(
                                width: double.infinity,
                                decoration: BoxDecoration(
