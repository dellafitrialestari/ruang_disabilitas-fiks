...
import 'payment_reguler_model.dart';
export 'payment_reguler_model.dart';

class PaymentRegulerWidget extends StatefulWidget {
  const PaymentRegulerWidget({Key? key}) : super(key: key);

  @override
  _PaymentRegulerWidgetState createState() => _PaymentRegulerWidgetState();
}

class _PaymentRegulerWidgetState extends State<PaymentRegulerWidget> {
  late PaymentRegulerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentRegulerModel());
  }
