...
import 'payment_gold_model.dart';
export 'payment_gold_model.dart';

class PaymentGoldWidget extends StatefulWidget {
  const PaymentGoldWidget({Key? key}) : super(key: key);

  @override
  _PaymentGoldWidgetState createState() => _PaymentGoldWidgetState();
}

class _PaymentGoldWidgetState extends State<PaymentGoldWidget> {
  late PaymentGoldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentGoldModel());
  }
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              var url = await initiatePayment(int.tryParse(columnPricingRecord.hargaG.replaceAll("Rp. ", "").replaceAll(".", "")), currentUserEmail, "gold");
                              if(url != null) {
                                Navigator.push(
                                  context,
